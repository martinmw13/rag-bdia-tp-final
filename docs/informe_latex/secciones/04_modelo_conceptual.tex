...
La Figura~\ref{fig:conceptual} resume las tres áreas del dominio. Las figuras
siguientes muestran cada una por separado para que las cardinalidades se lean
con claridad.
...
consultas, respuestas y evidencia. Cada actor tiene un perfil, y el permiso se
define por clase documental. Una respuesta exitosa debe conservar evidencia
documental o estructurada; un resultado negativo no admite evidencia. La
auditoría registra el actor, el perfil efectivo y la correlación necesaria para
