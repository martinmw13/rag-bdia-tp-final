...
El SQL completo de C1--C6 se encuentra en
\path{db/consultas/04_consultas.sql}; C7--C9 están en
\path{db/consultas/06_consultas_seguridad.sql}. La tabla resume la pregunta, el
patrón y el resultado comprobado; esos archivos son la referencia ejecutable de
la implementación.
