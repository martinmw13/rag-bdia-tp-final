...
Cada caso declara parámetros, resultado esperado y orden estable mediante
códigos de negocio.
...
C1--C7 producen los siete pares \texttt{consulta}--\texttt{respuesta} del
conjunto. C8 y C9 reutilizan esas interacciones para comprobar aislamiento y
trazabilidad; no crean dos conversaciones adicionales. Esta distinción evita
confundir cantidad de casos SQL con cantidad de interacciones simuladas.
